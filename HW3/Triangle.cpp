...
Triangle Triangle::operator++()
{
	...
	return Triangle(getPosX(), getPosY(), getPoint1X(), getPoint1Y(), getPoint2X(), getPoint2Y(), getPoint3X(), getPoint3Y(), getColor(), getRotateAngle(), getRotateX(), getRotateY(), getLength());
}
...
Triangle Triangle::operator++(int ignoreMe)
{
	...
	return Triangle(tempPosX, tempPosY, getPoint1X(), getPoint1Y(), getPoint2X(), getPoint2Y(), getPoint3X(), getPoint3Y(), getColor(), getRotateAngle(), getRotateX(), getRotateY(), getLength());
}
