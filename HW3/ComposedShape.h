  ...
  public:
	...
	class ShapeElem
	{
	  ...
	  public:
		...
		friend ostream &operator<<(ostream &outs, ShapeElem &obj);
	...
	ShapeElem &operator[](int index);			  //lvalue
	const ShapeElem &operator[](int index) const; //rvalue
	ComposedShape &operator+=(ShapeElem shp);

	vector<ShapeElem> &getShapes();
	void setShapes(vector<ShapeElem> shapes);
